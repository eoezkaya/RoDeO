...
class Griewank2DTest : public ::testing::Test {
protected:
	void SetUp() override {}
	...
	Griewank2DFunction testFun;

};


TEST_F(Griewank2DTest, testTangent){
	...
	double expectedValue = griewank2D(x.memptr());
	...
	double fp = griewank2D(xp.memptr());
	double fm = griewank2D(xm.memptr());
...
TEST_F(Griewank2DTest, testAdjoint){
	...
	fp = griewank2D(xp.memptr());
	fm = griewank2D(xm.memptr());
