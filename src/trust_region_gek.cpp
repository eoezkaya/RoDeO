...
void AggregationModel::saveHyperParameters(void) const{
	...
	kernelRegressionModel.saveHyperParameters();
	krigingModel.saveHyperParameters();
...
void AggregationModel::loadHyperParameters(void){
	...
	kernelRegressionModel.loadHyperParameters();
	krigingModel.loadHyperParameters();
