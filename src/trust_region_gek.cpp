...
//#endif
//
//	if (model_settings.visualizeKrigingValidation || model_settings.visualizeKernelRegressionValidation ){
//
...
//	mat visualizeKriging;
//
//	if(model_settings.visualizeKrigingValidation){
//
//
...
//	mat visualizeKernelRegression;
//
//	if(model_settings.visualizeKernelRegressionValidation){
//
//		visualizeKernelRegression = zeros(Nval,2);
//
//
...
//	mat visualizeAggModel;
//
//	if(model_settings.visualizeAggModelValidation){
//
//		visualizeAggModel = zeros(Nval,2);
//
//
