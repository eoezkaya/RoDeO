...
void test01(void)
{
    ...
    /* this function just opens a bitmap file and saves it with another name */
    ...
    printf("image witdth = %d\n",image.width());
    printf("image has = %d pixels\n",image.pixel_count());
    printf("image has = %d byte per pixel\n",image.bytes_per_pixel());
...
void test03(void)
{
    ...
    printf("original image witdth = %d\n",image.width());
    printf("original image has = %d pixels\n",image.pixel_count());
    ...
    printf("subsampled_image1 height = %d\n",subsampled_image1.height());
    printf("subsampled_image1 witdth = %d\n",subsampled_image1.width());
    printf("subsampled_image1 has = %d pixels\n",subsampled_image1.pixel_count());
    ...
    printf("subsampled_image2 height = %d\n",subsampled_image2.height());
    printf("subsampled_image2 witdth = %d\n",subsampled_image2.width());
    printf("subsampled_image3 has = %d pixels\n",subsampled_image2.pixel_count());
    ...
    printf("subsampled_image3 height = %d\n",subsampled_image3.height());
    printf("subsampled_image3 witdth = %d\n",subsampled_image3.width());
    printf("subsampled_image3 has = %d pixels\n",subsampled_image3.pixel_count());
...
void test04(void)
{
    ...
    printf("upsampled_image1 height = %d\n",upsampled_image1.height());
    printf("upsampled_image1 witdth = %d\n",upsampled_image1.width());
    printf("upsampled_image1 has = %d pixels\n",upsampled_image1.pixel_count());
